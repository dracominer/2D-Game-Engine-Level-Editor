...
public class ParticleSystem {
	...
	public ParticleSystem(ParticleTexture texture, float pps, float speed, float gravityComplient, float lifeLength, float scale, Level level) {
	...
	protected void emitParticle(Vector3f center) {
		...
		new Particle(texture, new Vector3f(center), velocity, gravityComplient, lifeLength, generateRotation(), scale, level);
	}
	...
	protected static Vector3f generateRandomUnitVectorWithinCone(Vector3f coneDirection, float angle) {
	...
	public void createExplosion(Vector3f systemCenter, int amount) {
