package com.engine.render.buffers;
...
public class GameFrameBuffer implements Cleanupable {
	...
	public void bindDepthBuffer() {
		bindFrameBuffer(depthBuffer, WIDTH, HEIGHT);
	}
